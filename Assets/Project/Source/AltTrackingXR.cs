...
namespace CookieNoir.VDayXR
{
    public class AltTrackingXR : AltTracking
    {
        ...
        public UnityEngine.InputSystem.XR.TrackedPoseDriver HmdPoseDriver;
        ...
        protected override void Awake()
        {
            ...
            var trackingType = HmdPoseDriver.trackingType;

            _lerpPosition = trackingType == TrackingType.PositionOnly ||
                            trackingType == TrackingType.RotationAndPosition;

            _lerpRotation = trackingType == TrackingType.RotationOnly ||
                            trackingType == TrackingType.RotationAndPosition;
